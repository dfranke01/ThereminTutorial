...
//char *song = "MissionImp:d=16,o=6,b=95:32d,2d#,8d7,32d#5";
...
songData* RTTL2SongData( char* RTTL, int * );

/*songData STT[] = {{NOTE_FS3,   138/tempo,     7+3},       
...
songData SWOTR[] = {{NOTE_FS3, 69, 10},       
 ...
 static void main ()
 {
	...
	cout << "newSongLength = " << newSongLength <<endl;
	for( int i = 0; i < newSongLength; i++ )
		cout << "note = " << newSong[i].note << " duration = " << newSong[i].duration << " volume = " << newSong[i].volume << endl;
